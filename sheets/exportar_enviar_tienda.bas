...
Private Sub borrar_titulos()
    Dim sh As Worksheet
    Set sh = ThisWorkbook.Sheets("Envío")
...
Private Sub agregar_titulos()
    ...
    data = Array("Código", "Descripción", "Cantidad", "Precio")
...
Private Sub crear_tabla()
    ...
    sh.ListObjects.Add(xlSrcRange, Range("$A$1:$D$" & lRow), , xlYes).Name = _
        "Tabla1"
